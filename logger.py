# Module:  [root]
# SubComponent:   logger
# COMPONENT:  Dynamometer Controller
# Project:    Cal Poly Dynamometer Testing 2023
...
# Config
loggingFileLocation = "logs"

# Create & configure logging file handler
def CreateLoggingFh():
    Current_time = datetime.now().strftime('%Y-%m-%d__%H-%M-%S')
    fh = logging.FileHandler(loggingFileLocation + '/DynamometerControl-' + Current_time + '.log')
